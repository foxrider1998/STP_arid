        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <a class="btn btn-danger" href=" <?php echo base_url('Admin/report_apg') ?>"> <i class="fa fa-print"></i> Export dan Print </a>
                    ...
                    <tbody>
                      ...
                      foreach ($apung as $apg) : ?>
                        <tr>
                          ...
                          <td align="center">
                            <a class="btn btn-success btn-sm " href="<?php echo base_url('Admin/detail_apg/' . $apg->id) ?>">
                              <i class="fa fa-search-plus"></i>
                            </a>
                          </td>
                          <td onclick="javascript: return  confirm('Anda  yakin  hapus?')" align="center">
                            <a class="btn btn-danger btn-sm " href="<?php echo base_url('Admin/hapus_apg/' . $apg->id) ?>">
                              <i class="fa fa-trash"></i>
                            </a>
                          </td>
                          <td align="center">
                            <a class="btn btn-primary btn-sm " href="<?php echo base_url('Admin/edit_apg/' . $apg->id) ?>">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel">FORM INPUT DATA PAKAN APUNG</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <?php echo form_open_multipart('Admin/tambah_apg'); ?>
