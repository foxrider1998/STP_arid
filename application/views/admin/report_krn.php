                                                        ...
                                                        <body class="hold-transition sidebar-mini">
                                                            <div class="wrapper">
                                                                ...
                                                                <div class="content-wrapper">
                                                                    ...
                                                                    <section class="content-header">
                                                                        <div class="col-sm-12">
                                                                            <h1 align="center">Data karantina</h1>
                                                                        </div>
                                                                    </section>
                                                                    ...
                                                                    <section class="content">
                                                                        <div class="container-fluid">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    <a class="btn btn-primary" href=" <?php echo base_url('Admin/karantina') ?>">Kembali</a>
                                                                                    <a target="_blank" class="btn btn-danger" href=" <?php echo base_url('Admin/cetak_krn') ?>"> <i class="fa fa-print"></i> Print</a>
                                                                                    <!-- /.card -->
                                                                                    <div class="card">
                                                                                        <!-- /.card-header -->
                                                                                        <div class="card-body">
