        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo base_url() . 'Admin/QC'; ?>" class="btn btn-primary">STANDAR QC</a>
                                </div>
                            </div>
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo base_url() . 'Admin/pjadi'; ?>" class="btn btn-primary">JADWAL PRODUKSI</a>
                                </div>
                            </div><!-- /.card -->
                        </div>
                        <!-- /.col-md-6 -->
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title m-0">BAGGING</h5>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title">LAPORAN BUKTI HARIAN PRODUKSI BAGGING</h6>

                                    <p class="card-text">pilah,tata,rapihkan,biasakan.</p>
                                    <a href="<?php echo base_url() . 'Admin/apung'; ?>" class="btn btn-primary">BHP Bagging</a>
                                </div>
                            </div>

                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h5 class="card-title m-0">WAREHOUSE</h5>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-title">Gudang Pakan Jadi</h6>

                                    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                    <a href="#" class="btn btn-primary">Laporan Gudang jadi</a>
                                </div>
                            </div>
                ...
                <footer class="main-footer">
                    ...
                    <!-- Default to the left -->
                    <strong>Copyright &copy; 2014-2019 <a href="https://adminlte.io">ARIDHASAN</a>.</strong> All rights reserved.
                </footer>
            </div>
            <!-- ./wrapper -->
