        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <a class="btn btn-primary" href=" <?php echo base_url('Admin/gudang') ?>">Kembali</a>
                            <a target="_blank" class="btn btn-danger" href=" <?php echo base_url('Admin/cetak_gdg') ?>"> <i class="fa fa-print"></i> Print</a>
                            <!-- /.card -->
                            <div class="card">
                                <!-- /.card-header -->
                                <div class="card-body">
